...
HD_PWD='C:/Users/chiur/code/teamcrypto-security/present-russell/present/present.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Test_Encrypt.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Test_Encrypt.tcl
