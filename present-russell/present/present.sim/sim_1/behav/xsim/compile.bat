...
REM
REM Generated by Vivado on Sat Feb 19 11:22:04 -0500 2022
...
echo "xvlog --incr --relax -L uvm -prj testbench_ksa_vlog.prj"
call xvlog  --incr --relax -L uvm -prj testbench_ksa_vlog.prj -log xvlog.log
